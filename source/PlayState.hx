...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		switch (curStage)
		{
			...
			case 'eyzgonal':
				{
					defaultCamZoom = 0.85;
					curStage = 'eyzgonal';
					var bg:FlxSprite = new FlxSprite(-400, -200).loadGraphic(Paths.image('eyzgonal'));
			...
			case 'kylespark':
				GameOverSubstate.loopSoundName = 'gameOver-kyles';
				GameOverSubstate.endSoundName = 'gameOverEnd-kyles';
				GameOverSubstate.characterName = 'bf-kyles-dead';
